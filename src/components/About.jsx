...
const About = () => {
  return (
    <div className="flex h-screen md:my-10 flex-col md:flex-row items-center gap-10 px-5 md:px-10 lg:px-32 vs:gap-2 vs:mt-0">
      <div className="w-full lg:h-[100%] md:h-[100%] sm:h-[50%] vs:h-[40%] md:w-6/12 flex justify-center items-center vs:my-0 lg:p-20 md:p-20 sm:p-2 vs:p-1">
        <img
          src={EDURIGHTS}
          className="w-full md:h-[80%] md:rounded-xl lg:rounded-xl sm:rounded-xl vs:rounded-xl vs:my-0 vs:py-0 vs:w-[100%] vs:h-[300px]"
          alt="edurights-about"
        />
      </div>
      <div className="w-full md:w-6/12">
        ...
        <p className="text-lg md:text-2xl text-justify md:text-left vs:text-sm ">
          ...
          D.El.Ed,Management, Nursing and Engineering courses. We understand the
          pivotal role education plays in shaping careers and futures. Our
