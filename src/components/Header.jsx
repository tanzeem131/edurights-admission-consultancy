...
const Header = () => {
  ...
  return (
    <div className='bg-black flex justify-between items-center h-24 mx-auto px-4 text-white fixed top-0 w-full z-50 vs:mb-0 vs:pb-0'>
      {/* Logo */}
      <h1 className='w-full md:text-3xl font-bold text-[#D69527] uppercase sm:text-xl vs:text-xl'>edurights admission consultancy</h1>
      ...
      >
        {/* Mobile Logo */}
        <h1 className='w-full text-3xl font-bold text-[#D69527] m-4 sm:text-xl vs:text-xl'>edurights admission consultancy</h1>
