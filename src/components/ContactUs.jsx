        ...
        <div className="grid grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col items-center w-[70%] p-5 m-5 gap-4">
                <div className="text-2xl">
                    ...
                    <p><span className="font-bold">Phone :</span> +91 6202400037</p>                        <p><span className="font-bold">Email :</span> edurightsconsultant@gmail.com</p>
                </div>
                <div>
                    <div className="bg-[#f3ec959a] p-2"> 
                        <h1 className="font-bold text-2xl">For more info, email us!</h1>                         <form className="flex flex-col gap-1">
