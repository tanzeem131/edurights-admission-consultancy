...
const ContactUs = () => {
  return (
    <div class="flex items-center justify-center py-20">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-[80%] max-w-screen-lg">
        <div class="flex justify-center">
          <iframe
            class="w-full h-80 md:w-3/4 md:h-[450px] rounded-lg"
            title="location"
        ...
        <div class="flex justify-center items-start md:items-center font-bold">
          <div class="text-base md:text-lg w-full md:w-3/4 space-y-4">
